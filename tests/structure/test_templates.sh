...
require_line "templates/financial-analysis.md" "## Derived Financial Quality Metrics"
require_line "templates/financial-analysis.md" "derived.financial_quality_metrics"
...
require_line "templates/quality-and-valuation-check.md" "derived.financial_quality_metrics"
...
require_line "templates/investment-memo.md" "## Pricing Stage Assessment"
require_line "templates/investment-memo.md" "| Stage | Status | Evidence | Transition Trigger |"
require_line "templates/investment-memo.md" "| Probability | EPS / Driver Assumption | Multiple Assumption | Scenario-Derived Price Range | Validation Trigger | Break Condition |"
...
require_line "templates/market-action-read.md" "## Derived Market Confirmation Metrics"
require_line "templates/market-action-read.md" "derived.market_confirmation_metrics"
...
require_line "templates/research-html-summary.html" "{{KPI_CARDS}}"
require_line "templates/research-html-summary.html" "{{OPEN_QUESTIONS_ROWS}}"
...
require_line "templates/research-html-summary.html" "{{TEMPLATE_VERSION}}"
require_line "templates/research-html-summary.html" "What Confirms"
require_line "templates/research-html-summary.html" "Tracking Impact"
...
require_line "templates/active-decisions.md" "## Headline"
require_line "templates/active-decisions.md" "## Summary"
require_line "templates/active-decisions.md" "## Stance"
