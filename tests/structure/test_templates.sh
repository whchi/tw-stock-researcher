...
require_line "templates/active-decisions.md" "## Evidence → Thesis Impact → Next Verification"
require_line "templates/active-decisions.md" "| Evidence | Source / Observation Date | Thesis Impact (Business / Pricing / Both) | Next Verification | Failure Signal |"
...
require_line "templates/signal-log.md" "Evidence → Thesis Impact → Next Verification"
require_line "templates/signal-log.md" "| Date | Signal Layer | Signal Type | Claim Type | Classification | Source / Observation Date | Evidence | Price Reaction | Revenue/Earnings Validation | Thesis Impact (Business / Pricing / Both) | Next Verification |"
reject_line "templates/signal-log.md" "Next Action"

require_line "templates/investment-memo.md" "## Cross-Layer Conflict Map"
require_line "templates/investment-memo.md" "## Adversarial Review"
require_line "templates/investment-memo.md" "| Bull Researcher |"
require_line "templates/investment-memo.md" "| Bear Researcher |"
require_line "templates/investment-memo.md" "| Risk Reviewer |"
require_line "templates/research-html-summary.html" "{{DATA_AVAILABILITY_ROWS}}"
require_line "templates/research-html-summary.html" "{{EVIDENCE_THESIS_VERIFICATION_ROWS}}"
require_line "templates/research-html-summary.html" "{{CROSS_LAYER_CONFLICT_ROWS}}"
require_line "templates/research-html-summary.html" "{{ADVERSARIAL_REVIEW_ROWS}}"
