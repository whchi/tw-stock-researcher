...
3. Include Bull/Base/Bear scenarios with probability weights, EPS or driver assumptions, and scenario-derived price ranges; anchor scenario multiples to the `fundamentals-data.json` valuation band rather than remembered multiples.
4. Explain expectation gaps: market belief, verified evidence, narrative-only claims, and verification needed.
5. Summarize evidence support without duplicating raw tables from other layers.
6. Capture critical unresolved questions and non-portable claims.
